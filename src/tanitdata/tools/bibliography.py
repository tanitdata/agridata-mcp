...
async def search_bibliography(
    ...
    # Approximate Tier 1 total (Base: 22,782 + Fonds: 2,265 as of 2026-04).
    # May drift as ONAGRI adds records; exact count not critical for display.
    total_searched = 25_047
